...
- [ ] Phase 3: State Machine — 2PC (pending->committed) via DashMap, in rust_core/src/state.rs
- [ ] Phase 4: FFI Bridge — PyO3 zero-copy (PyBytes), py.allow_threads() on all I/O
